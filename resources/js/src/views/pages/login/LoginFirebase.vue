<template>
  <div>
    ...
    <div class="social-login-buttons flex flex-wrap items-center mt-4" v-else>
      ...
      <!-- TWITTER -->
      <div class="bg-twitter pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4" @click="AuthProvider('twitter')">
      ...
      <!-- GOOGLE -->
      <div class="bg-google pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4" @click="AuthProvider('google')">
      ...
      <!-- GITHUB -->
      <div class="bg-github pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4" @click="AuthProvider('github')">
