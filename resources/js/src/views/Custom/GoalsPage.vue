...
<script>
import EmailSidebar        from './../apps/email/EmailSidebar.vue'
import MailItem            from './../apps/email/MailItem.vue'
import EmailView           from './../apps/email/EmailView.vue'
