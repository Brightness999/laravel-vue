...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    status_local: {
      get: function get() {
        return {
          label: this.capitalize(this.user_data.status),
          value: this.user_data.status
        };
      },
    ...
    role_local: {
      get: function get() {
        return {
          label: this.capitalize(this.user_data.role),
                      ...
                      _c("table", [
                        _c("tr", [
                          ...
                          _c("td", { staticClass: "font-semibold" }, [
                            _vm._v(_vm._s(_vm.user_data.full_name))
                          ])
                        ]),
                        _vm._v(" "),
                        _c("tr", [
                          ...
                          _vm._v(" "),
                          _c("td", { staticClass: "font-semibold" }, [
                            _vm._v(_vm._s(_vm.user_data.email))
                          ])
                        ]),
                        _vm._v(" "),
                        _c("tr", [
                          ...
                          _c("td", { staticClass: "font-semibold" }, [
                            _vm._v(
                              _vm._s(
                                _vm.user_data.position
                                  ? _vm.user_data.position.name
                                  : ""
                              )
                            )
                          ])
                      ...
                      _c("table", [
                        ...
                        _c("tr", [
                          ...
                          _c("td", { staticClass: "font-semibold" }, [
                            _vm._v(
                              _vm._s(
                                _vm.user_data.department
                                  ? _vm.user_data.department.name
                                  : ""
                              )
                            )
                          ])
                        ...
                        _c("tr", [
                          ...
                          _c(
                            ...
                            _vm._l(_vm.user_data.hrs, function(hr, index) {
                              return _c("span", [
                                index !== 0
                                  ? _c("span", [_vm._v(", ")])
                                  : _vm._e(),
                                _c("span", [_vm._v(_vm._s(hr.full_name))])
                              ])
                            }),
                            0
                          )
                        ...
                        _vm._v(" "),
                        _c("tr", [
                          _c("td", [_vm._v("Mentors:")]),
                          _vm._v(" "),
                          _c(
                            "td",
                            { staticClass: "font-semibold" },
                            _vm._l(_vm.user_data.mentors, function(
                              mentor,
                              index
                            ) {
                              return _c("span", [
                                index !== 0
                                  ? _c("span", [_vm._v(", ")])
                                  : _vm._e(),
                                _c("span", [_vm._v(_vm._s(mentor.full_name))])
                              ])
                            }),
                            0
                          )
